                                ...
                                <tbody class="text-center">
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-info btn-sm" href="<?= base_url('admin/staff/edit/' . $val->staff_id) ?>" title="Edit"><i class="fas fa-pencil-alt"> </i> Edit</a>

                                                    <a class="btn btn-danger btn-sm" href="#!" title="delete" onclick="myFunctionDelete('<?= base_url('admin/staff/staff_delete/' . $val->staff_id) ?>')"><i class="fas fa-trash"> </i> Delete</a>
                                                </td>
                                            </tr>
                                    <?php }
                                    } ?>
