                                ...
                                <tbody class="text-center">
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-info btn-sm" href="<?= base_url('staff/patient/edit/' . $val->patient_id) ?>" title="Edit"><i class="fas fa-pencil-alt"> </i> Edit</a>

                                                    <a class="btn btn-danger btn-sm" href="#!" title="delete" onclick="myFunctionDelete('<?= base_url('staff/patient/patient_delete/' . $val->patient_id) ?>')"><i class="fas fa-trash"> </i> Delete</a>
                                                </td>
                                            </tr>
                                    <?php }
                                    } ?>
