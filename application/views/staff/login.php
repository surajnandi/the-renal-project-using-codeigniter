...
<body class="hold-transition login-page">
	<div class="login-box">
		<div class="login-logo">
			<a href="javascript:void(0);"><b><i class="fas fa-user-tie text-danger"></i> <?= $show_title ?> </b></a>
		</div>
		<!-- /.login-logo -->
		<div class="card">
			<div class="card-body login-card-body">
				...
				<form action="staff/login" id="quickForm" method="post">
					<div class="form-group mb-3">
						<div class="input-group">
							<input type="text" name="staff_email_id" value="<?php echo set_value('staff_email_id'); ?>" autocomplete='off' class="form-control" placeholder="Email">
